...
async function main() {
    ...
    const proxyUpgrade = await upgrades.upgradeProxy(proxyAddress, StakeV2Factory);

    const proxyUpgradeAddress = await proxyUpgrade.getAddress();

    console.log("Proxy Upgraded to: ", proxyUpgradeAddress);
}
